  ...
  return (
    <div className="border border-gray-200 p-6 flex flex-col gap-4">
      <div className="flex items-center gap-2 mb-2">
        <SiGithub size={14} className="text-black" />
...
async function GithubStatsFetcher() {
  let stats;
  try {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex justify-between items-center text-sm">
        <span className="text-gray-600">Commits All-Time</span>
        <span className="font-semibold">{stats.commits.toLocaleString()}</span>
      </div>
      <div className="flex justify-between items-center text-sm">
